...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ __('Provinces') }}</h1>

   <a href="#" 
   data-size="lg" 
   data-url="{{ route('provinces.store') }}" 
   data-ajax-popup="true" 
   data-bs-toggle="tooltip" 
   title="{{ __('Manage Provinces') }}" 
   data-title="Manage Provinces"
