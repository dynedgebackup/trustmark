<form method="POST" action="{{ route('MenuGroup.store') }}">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <span class="validate-err">{{ $errors->first('name') }}</span>
                    <div class="form-icon-user">
                        <input type="text" name="icon" id="icon" class="form-control" value="{{ old('icon', $data->icon) }}" style="font-size:12px; padding:9px;">
                    </div>
                    <span class="validate-err" id="err_icon"></span>
                </div>
            </div>   
            <div class="col-md-10">
