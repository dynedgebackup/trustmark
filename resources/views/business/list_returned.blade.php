...
@section('content')
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row">
                         <h6 class="text-primary fw-bold m-0" style="font-size: 12px;">Returned Applications</h6>
                    </div>
                     <div class="table-responsive table mt-2" id="dataTable-1" role="grid"
                        aria-describedby="dataTable_info">
                        <table class="table my-0" id="dataTablereturned" style="width:100%; table-layout: fixed;">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th class="custom-th" style="width: 100px;">Evalutor</th> -->
                                    <th class="custom-th" style="width: 100px;">Remarks</th>
                                    <th class="custom-th" style="width: 100px;">Date Returned</th>
    ...
    var DIR =$("#DIR").val();
    const table = $('#dataTablereturned').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        pagingType: "full_numbers",
        ajax: {
            url: DIR +'get-list-returned',
            type: 'GET',
            data: {
                q: $("#details").val(),
    ...
    $('#dataTablereturned').on('click', '.toggle-text', function(e){
                e.preventDefault();
