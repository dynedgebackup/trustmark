            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="table-responsive table mt-2" id="dataTable-1" role="grid"
                        ...
                        <table class="table my-0" id="jqtabledataTableuser" style="width:100%; table-layout: fixed;">
                            <thead>
                                <tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
         ...
         $(document).ready(function(){
            ...
            var DIR =$("#DIR").val();
            const table = $('#jqtabledataTableuser').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
            ...
            $('#jqtabledataTableuser').on('click', '.toggle-text', function(e){
                        e.preventDefault();
