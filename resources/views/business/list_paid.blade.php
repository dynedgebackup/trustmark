...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 15px;">
        <h3 class="page-title">Paid Business Applications</h3>
    </div>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
           ...
           <!--  <div class="row" style="margin-bottom: 15px;">
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row">
                         <h6 class="text-primary fw-bold m-0" style="font-size: 12px;">Paid Applications</h6>
                    </div>
                    <div class="table-responsive table mt-2" id="dataTable-1" role="grid"
                        aria-describedby="dataTable_info">
                        <table class="table my-0" id="dataTablepaid" style="width:100%; table-layout: fixed;">
                            <thead>
                                <tr>
    ...
    var DIR =$("#DIR").val();
    const table = $('#dataTablepaid').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        pagingType: "full_numbers",
        ajax: {
            url: DIR +'get-list-paid',
            type: 'GET',
            data: {
                q: $("#details").val(),
    ...
    $('#dataTablepaid').on('click', '.toggle-text', function(e){
                e.preventDefault();
