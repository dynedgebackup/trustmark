...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 15px;">
        <h3 class="page-title">Under Evaluation Applications</h3>
    </div>
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="row mb-3">
                            <div class="col text-center">
                                <form action="{{ route('business.under-evaluation') }}" method="GET"
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row">
                         <h6 class="text-primary fw-bold m-0" style="font-size: 12px;">Draft Applications</h6>
                    </div>
                    <div class="table-responsive table mt-2" id="dataTable-1" role="grid"
                        aria-describedby="dataTable_info">
                        <table class="table my-0" id="dataTabledraftuser" style="width:100%; table-layout: fixed;">
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a href="{{ route('business.view', encrypt($business->id)) }}"
                                                ...
                                                <i class="custom-pencil-icon fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
                                @empty
    ...
    var DIR =$("#DIR").val();
    const table = $('#dataTabledraftuser').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        pagingType: "full_numbers",
        ajax: {
            url: DIR +'get-list-draft',
            type: 'GET',
            data: {
                q: $("#details").val(),
    ...
    $('#dataTabledraftuser').on('click', '.toggle-text', function(e){
                e.preventDefault();
