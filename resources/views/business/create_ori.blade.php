                        ...
                        <div class="multisteps-form__form">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control custom-input" type="tel"
                                                                id="number" placeholder="Mobile No." required
                                ...
                                <form action="{{ route('business.save_detail') }}" method="POST" id="detailsForm"
                                    ...
                                    <div id="form-content-1" class="multisteps-form__content">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-4"
                                            ...
                                            <div>
                                                <button class="btn btn-primary js-btn-prev me-2" type="button"
                                                    title="Previous" style="font-family:sans-serif;font-size:14px;">
                                                    Previous
                                                </button>
                                                <button class="btn btn-primary" type="submit" title="Next"
                                ...
                                <form action="{{ route('business.save_document') }}" method="POST" id="documentsForm"
                                    ...
                                    <div id="form-content-1" class="multisteps-form__content">
                                        ...
                                        <button type="button" class="btn btn-primary" id="addDocumentBtn"
                                            style=" padding: 4px 8px; font-size: 12px; float: inline-end;">
                                            Add Document
                                        </button>
                                        <br>
                                        <!-- <style>
                            ...
                            <div id="confirmation"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-9 col-md-9">
                                        <span class="custom-label text-break"><a
                                                href="{{ route('business.download_authorized', encrypt($business->id)) }}"
                                                class="d-flex align-items-center gap-2">
                                                <i class="fa fa-download"></i>
                                                <span class="custom-label"
                                                    title="{{ $filename }}">{{ $filename }}</span>
                                ...
                                <div class="row mb-2 align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        @if ($hasFile)
                                            <a href="{{ route('business.download_bmbe_doc', $business->id) }}"
                                                class="d-flex align-items-center gap-2" style="">
                                                <i class="custom-icon fa fa-download"></i>
                                                <span class="custom-label"
                                                    title="{{ $filename }}">{{ $shortName }}</span>
                                            </a>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button class="btn btn-primary js-btn-prev me-2" type="button" title="Previous"
                                            style="font-family:sans-serif;font-size:14px;">
                                            Previous
                                        </button>
...
<script>
    ...
    function createUrlField(url = '') {
        ...
        visitBtn.className = "btn btn-primary btn-sm ms-2";
        ...
        deleteBtn.onclick = () => {
            fieldWrapper.remove();
            // Optionally decrement urlFieldCount or handle gaps
        };
