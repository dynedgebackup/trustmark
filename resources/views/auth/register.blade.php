                            ...
                            <ul class="brand-logo navbar-left gap-2 justify-content-sm-start justify-content-center">
                                <li class="nav-item">
                                    <a class="navbar-brand d-flex gap-3 m-0 p-0" href="https://trustmark.bahayko.app/">
                                        <img class="navbar-img" src="{{ asset('assets/img/dti-bagong-text.png') }}"
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 15px;">
                        <h3 class="text-dark" style="font-family:sans-serif;font-size:20px;margin:0;"><span
                                style="color: rgba(var(--bs-dark-rgb), var(--bs-text-opacity));font-size: 20px;font-weight: bold;">REGISTER</span>
                        </h3>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row" style="margin-bottom:10px;">
                                            ...
                                            {{-- <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label custom-label">Username<span
                                                            class="required-field">*</span></label>
                                                    <input class="form-control custom-input" type="text" id="username"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control custom-input" type="tel"
                                                            id="number" placeholder="9123456789" maxlength="10"
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select custom-input select2" id="issued_id"
                                                        ...
                                                        @foreach ($requirements as $rep)
                                                            <option value="{{ $rep->id }}"
                                                                data-with-expiration="{{ trim($rep->with_expiration) }}">
                                                                {{ $rep->description }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control custom-input" type="date"
                                                        id="expirationDateInputVisible" placeholder="Date"
                                                        min="{{ $today }}" disabled>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateExpirationField() {
                ...
                const withExpiration = selected.data('with-expiration');

                console.log('withExpiration:', withExpiration);

                if (withExpiration === 1 || withExpiration === '1') {
                    $expirationVisible.prop('disabled', false).prop('required', true);
                } else {
                    $expirationVisible.prop('disabled', true).prop('required', false).val('');
            ...
            $issuedId.on('change select2:select', function() {
