                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            <form action="{{ route('dashboard') }}" method="GET"
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        <label for="Search"
                                            class="form-label custom-label">{{ __('From Date') }}</label>
                                        <input type="date" name="fromdate" id="fromdate"
                                            class="form-control custom-input" value="{{ $displayStartDate }}"
                                ...
                                <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        ...
                                        <input type="date" name="todate" id="todate"
                                            class="form-control custom-input" value="{{ $displayEndDate }}"
                                            style="font-size:12px; ">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="details" id="details"
                                        class="form-control custom-input" value="{{ request('details') }}"
                                        placeholder="Details">
                                </div>
