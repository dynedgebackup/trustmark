...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ __('Menu Module') }}</h1>

   <a href="#" 
   data-size="lg" 
   data-url="{{ route('MenuModule.store') }}" 
   data-ajax-popup="true" 
   data-bs-toggle="tooltip" 
   title="{{ __('Manage Menu Module') }}" 
   data-title="Manage Menu Module"
...
<div class="row d-flex align-items-center justify-content-end" style="padding-bottom: 20px;">
            <div class="col-md-3">
                <div class="form-group" id="parrent_reg_no">
                    <label for="Group_id_filter" class="form-label">{{ __('Group') }}</label>
                    <span class="validate-err"></span>
                    <div class="form-icon-user">
                        <select name="Group_id_filter" id="Group_id_filter" class="form-control select3" required style="width:100%;">
                            <option value=""></option>
...
$(document).ready(function() {
    select3Ajax("Group_id_filter","parrent_reg_no","getmenuGroupAjaxList");
    datatablefunction();
