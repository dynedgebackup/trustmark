...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ __('Manage Admin and Evaluator') }}</h1>

   <a href="#" 
   data-size="lg" 
   data-url="{{ route('evaluator.store') }}" 
   data-ajax-popup="true" 
   data-bs-toggle="tooltip" 
   title="{{ __('Manage Admin and Evaluator') }}" 
   data-title="Manage Admin and Evaluator"
