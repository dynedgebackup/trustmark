...
class ReturnedMailJob implements ShouldQueue
{
    ...
    {
        try {
            Mail::to($this->business->pic_email)->send(new ReturnedMail($this->business));

            Log::info('ReturnedMail sent successfully', [
