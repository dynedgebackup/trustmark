        ...
        foreach ($fees as $row) {
            $data[] = [
                'no' => $i++,
                    ...
                    'icon' => $row->icon ?'<i class="custom-icon '.$row->icon.'"></i>': ' ',
                    'slug' => $row->slug ?? ' ',
                    ...
                    'action' => '<a href="#" 
                                ...
                                data-url="' . url('/setting/MenuGroup/store?id=' . $row->id) . '" 
                                data-ajax-popup="true" 
                                data-size="lg" 
                                data-bs-toggle="tooltip" 
                                title="Edit" 
                                data-title="Manage Menu Group" style="background: #09325d !important;color: #fff;">
